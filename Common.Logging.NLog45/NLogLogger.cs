...
namespace Common.Logging.NLog45
{
	...
	public partial class NLogLogger : AbstractLogger
	{
		...
		protected class NLogFormatMessageCallbackFormattedMessage : FormatMessageCallbackFormattedMessage
		{
			...
			public NLogFormatMessageCallbackFormattedMessage(FormatMessageCallback formatMessageCallback)
				: base(formatMessageCallback)
			{ }
			...
			/// <param name="formatMessageCallback">The format message callback.</param>
			public NLogFormatMessageCallbackFormattedMessage(IFormatProvider formatProvider, FormatMessageCallback formatMessageCallback)
				: base(formatProvider, formatMessageCallback)
			{ }
		...
		{
			var format = new NLogFormatMessageCallbackFormattedMessage(formatMessageCallback).ToParameters(out object[] args);
		...
		{
			var format = new NLogFormatMessageCallbackFormattedMessage(formatProvider, formatMessageCallback).ToParameters(out object[] args);
