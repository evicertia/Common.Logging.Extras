...
using Context = NLog.MappedDiagnosticsContext;

namespace Common.Logging.NLog45
{
	/// <summary>
	/// A thread context for logger variables
	/// </summary>
	public class NLogThreadVariablesContext : IVariablesContext
	{
		...
		/// <summary>
		/// Gets the value of a variable within the thread context
		/// </summary>
		...
		/// <summary>
		/// Checks if a variable is set within the thread context
		/// </summary>
		...
		/// <summary>
		/// Removes a variable from the thread context by key
		/// </summary>
