...
using Context = NLog.NestedDiagnosticsLogicalContext;

namespace Common.Logging.NLog45
{
	/// <summary>
	/// A nested logical thread context for logger variables
	/// </summary>
	public class NLogNestedLogicalThreadVariablesContext : INestedVariablesContext
	{
		...
		/// <summary>
		/// Returns true if there is at least one item in the nested logical thread context; false, if empty
		/// </summary>
